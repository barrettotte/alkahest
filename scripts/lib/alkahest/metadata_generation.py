...
def quarto_metadata(publication):
    ...
    lines = [
        "# Generated by scripts/generate-publication-metadata.py; do not edit.",
        "book:",
...
def validate_repository(root):
    ...
    if '"metadata-generation", "check-metadata-generation.py"' not in texts["dispatcher"]:
        fail("source dispatcher does not include metadata generation")
    for marker in (
