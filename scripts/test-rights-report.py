...
def main():
    ...
    if machine != report or b"Release readiness: **BLOCKED**" not in outputs[
        "rights-credits.md"
    ]:
    ...
    artifact_failure(
        "changed",
        "stale or changed",
        lambda root: (root / "rights-credits.md").write_text(
...
if __name__ == "__main__":
    try:
        main()
    except (AssetError, OSError, RuntimeError, UnicodeError) as error:
