...
def check_icons(epub_language, epub_svg, html_css, epub_css, temp_epub):
    ...
    run_checked((sys.executable, "scripts/check-rendered-icons.py", str(BUILD / "html/icons.html"), str(components), temp_epub))
    require(
        html_css,
...
def check_locale(epub_language, temp_epub):
    ...
    run_checked((sys.executable, "scripts/check-unicode-spaces.py", "html", str(BUILD / "html/appendices/language-and-script.html")))
    run_checked((sys.executable, "scripts/check-unicode-spaces.py", "epub", temp_epub))
