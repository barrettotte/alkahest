...
per-book terminology plus narrow CSpell overrides.
...
and `docs/` paths in temporary repositories, then invokes the pinned CSpell and
Vale tools in rootless offline containers.
