...
check-compatibility: ## Validate template versions, migrations, and deprecations.
	python3 scripts/check-source.py compatibility

test-compatibility: ## Exercise release, migration, restoration, and stable-ID failures.
	python3 scripts/check-source.py --tests compatibility
