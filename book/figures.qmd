...
![A validated source-to-publication dependency graph.](figures/generated/build-dependency-graph.svg){#fig-build-dependency-graph fig-alt="Source and data both feed validation; validation feeds rendering; rendering produces HTML, EPUB, Typst PDF, and LuaLaTeX PDF outputs." width="100%"}
...
`alkahest.generators.graphs`; original Alkahest fixture, CC0 1.0.]{.figure-source}
:::
...
SVG from `alkahest.generators.circuits`. The exact Python environment is locked
by the root `uv.lock`, and `make check-circuits` requires a fresh offline
...
![](figures/generated/voltage-divider.svg){fig-alt="A nine-volt source drives a one-kilohm upper resistor and two-kilohm lower resistor in series. The midpoint output is six volts, the current is three milliamperes, and the lower return is grounded." width="80%"}

A nine-volt resistive voltage divider. [Source: generated by
`alkahest.generators.circuits`; original Alkahest fixture, CC0 1.0.]{.figure-source}
:::
...
SVG from `alkahest.generators.chemistry`. Its canonical reaction SMILES is
...
`alkahest.generators.chemistry`; original Alkahest fixture, CC0 1.0.]{.figure-source}
:::
...
portable SVGs through `alkahest.generators.computing`. Together they
...
`alkahest.generators.computing`; original Alkahest fixture, CC0
1.0.]{.figure-source}
:::
...
and records fixture provenance. `alkahest.generators.physics` turns it
...
`alkahest.generators.physics`; original Alkahest fixture, CC0 1.0.]{.figure-source}
:::
